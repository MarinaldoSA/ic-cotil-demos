...
<section class="main">
  <div class="jumbotron jumbotron-fluid text-center">
      <div class="container">
          <h1 class="display-4">Comentários <strong>(seguro)</strong></h1>
    ...
    <div class="col-sm-3"></div>
        ...
        <div class="col-md-6">
            ...
            <!-- form -->
            <form action="comentou_seguro.php" method="POST" class='envia-comentario'>
            ...
            <?php
                ...
                if($comentarios_conteudo != NULL){
                    foreach($comentarios_conteudo as $conteudo){
                        ...
                        echo "<div class='container-fluid comments'><strong>" . htmlspecialchars($usuario[0]['username']) . "</strong> comentou: " . htmlspecialchars($conteudo['comentario']) . "</div><br/>";
                    }
                }
            ?>
